...
@router.post('/{blog_id}', response_model=CreateCommentResponse, description="Add a new comment to a blog post")
...
@router.delete('/{blog_id}/{comment_id}', response_model=DeleteCommentResponse, description="Delete a comment from a blog post")
